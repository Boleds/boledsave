...
BOT_TOKEN = "7724799535:AAFydtfo8iqZM2SZFLpOzObv-T4UyfPqTLc"
PAYMENT_CHANNEL = "@Minerads_community" #tambahkan saluran pembayaran di sini termasuk tanda '@'
OWNER_ID = 7724799535 #tulis id pengguna pemilik di sini.. dapatkan dari @MissRose_Bot dengan /id
CHANNELS = ["@Minerads_community"] #tambahkan saluran yang akan diperiksa di sini dalam format - ["Saluran 1", "Saluran 2"]
              #Anda dapat menambahkan saluran sebanyak mungkin di sini dan juga menambahkan tanda '@' sebelum nama pengguna saluran
